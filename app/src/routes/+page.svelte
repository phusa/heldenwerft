...
<div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-16 px-4 lg:px-16">
	<div class="pb-12 pt-24 px-3 lg:px-16">
		...
		<p class="mt-4 text-gray-900">
			Im Rahmen der Veranstaltung entwickeln Studierende des M.A. International Management Studies –
			BWL der Europa-Universität Flensburg Lösungsansätze für konkrete Probleme und
			Herausforderungen kleinerer gemeinnütziger Organisationen, um diese – in enger Abstimmung mit
			den verschiedenen Organisationen – selber umzusetzen.
		</p>
		<p class="mt-4 text-gray-900 font-bold">
			Wie das geht, wie ihr euch als Organisation um Unterstützung bewerben oder als Studierender
			...
			<div class="grid gap-8 row-gap-5 lg:grid-cols-3">
				...
				<div class="overflow-hidden">
					...
					>
						...
						<p class="mb-2 text-white">
							Die Projekte, die von den Studierenden umgesetzt werden, können ganz verschiedener
							Natur sein. Unsere Schwerpunkte sind: Marketing & Reichweite, Strategie & Organisation
							oder Finanzierung & Fundraising.
						</p>
					</div>
				</div>
				<div class="overflow-hidden">
					...
					>
						...
						<p class="mb-2 text-white">
							...
							sich im Rahmen ihres Studiums gesellschaftlich engagieren – und schaffen damit einen
	...
	<div class="mx-auto max-w-screen-2xl px-4 py-8 sm:py-12 lg:py-16">
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
			...
			<div class="lg:py-24">
				...
				<p class="mt-2">
					Unsere Studierenden unterstützen euch für die Dauer eines Semesters bei eurer
					individuellen Problemstellung.
				</p>
				<p class="mt-2">
					Wie das genau funktioniert, ob ihr mitmachen könnt & wie ihr euch für die Teilnahme am
					Service Learning Projekt bewerbt, erfahrt ihr bei Klick auf den folgenden Button!
				</p>
				<button
