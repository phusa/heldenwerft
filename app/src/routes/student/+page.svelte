...
<div class="grid lg:grid-cols-2 px-6 lg:px-16">
	<div class="pt-24 lg:px-16">
		<h1 class="text-3xl font-bold sm:text-4xl text-white">Service Learning für Studenten:</h1>

		<p class="mt-4 text-gray-900 font-bold">
			// Dieser Text muss noch angepasst werden. // // Dieser Text muss noch angepasst werden. // // Dieser Text muss noch angepasst werden. //
		</p>
		<p class="mt-4 text-gray-900">
			// Dieser Text muss noch angepasst werden. // // Dieser Text muss noch angepasst werden. // // Dieser Text muss noch angepasst werden. // // Dieser Text muss noch angepasst werden. // // Dieser Text muss noch angepasst werden. //
		</p>
		<a href="https://www.uni-flensburg.de/studium-lehre/studienangebot/management/ma-international-management-studies-bwl" class="link link-primary flex items-center mt-4 text-white" target="_blank" rel="noreferrer">
			...
			Allgemeine Informationen zum Studiengang für Interessierte
		</a>
	</div>
</div>
<div>
...
<div class="px-4 lg:px-24 bg-white">
	...
	<div class="mt-8">
		<details class="group [&_summary::-webkit-details-marker]:hidden mb-2">
			...
			>
				<h2 class="text-xl my-2">// Dieser Text muss noch angepasst werden. //?</h2>
...
<div class="px-4 py-8 sm:py-12 lg:px-6 xl:px-36 bg-white">
	<h1 class="text-4xl font-bold text-[#009CF3] pb-2">
		Bisher umgesetzte Projekte
	</h1>
	<h2 class="text-xl font-bold pb-4">
		Ihr braucht ein wenig Inspiration? Hier findet ihr eine Auswahl von Projekten, die wir bisher schon umgesetzt haben.
	</h2>
	<Projects limit={3} />
</div>
