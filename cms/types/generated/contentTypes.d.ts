  ...
  attributes: {
    Type: Attribute.Enumeration<
      [
        ...
        'Website Feature Entwickeln',
        'Website Relaunch'
      ]
    >;
    TypeFurther: Attribute.Text;
    Idea: Attribute.Text;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Organisations: Attribute.Relation<
      ...
      'api::organization.organization'
    >;
    Testimonials: Attribute.Component<'element.testimonial-card', true>;
...
export interface ApiSettingSetting extends Schema.SingleType {
  ...
  attributes: {
    ...
    SocialMediaLinks: Attribute.Component<'element.social-media-link', true>;
    ContactDetails: Attribute.RichText;
    ApplicationFormRecipients: Attribute.Relation<
      'api::setting.setting',
      'oneToMany',
      'plugin::users-permissions.user'
    >;
